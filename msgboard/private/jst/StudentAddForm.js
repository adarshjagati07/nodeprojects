...
response.write("");
response.write("    <span style='color:red'>"+request.errorMessage+"</span>");
response.write("");
response.write("    <form action=\"addStudent\" onsubmit=\"return validateForm(this)\">");
response.write("        <table>");
response.write("            <tr>");
response.write("                <td>Roll Number : </td>");
response.write("                <td><input type=\"text\" id=\"rollNumber\" value=\""+request.rollNumber+"\" name=\"rollNumber\" maxlength=\"20\" size=\"22\"></td>");
response.write("                <td><span id=\"rollNumberErrorSection\" style=\"color: red;\"></span></td>");
response.write("            </tr>");
response.write("            <tr>");
response.write("                <td>Name : </td>");
response.write("                <td><input type=\"text\" id=\"name\" value=\""+request.name+"\" name=\"name\" maxlength=\"20\" size=\"22\"></td>");
